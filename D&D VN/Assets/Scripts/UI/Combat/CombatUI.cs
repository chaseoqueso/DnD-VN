...
public class CombatUI : MonoBehaviour
{
    ...
    #region Ability Charge and Queue
        ...
        public void QueueAbilityOnChargeComplete()
        {
            ...
            var queuedAction = activeAction.PerformAction( activeCharacter, activeTargetCreature, chargePercent );
            float delay = activeAction.CalculateChargeDelay(activeCharacter.data, chargePercent);
            string description = activeAction.GetAbilityPerformedDescription(activeCharacter, activeTargetCreature, chargePercent);
